...
t[#t + 1] = Def.ActorFrame {
	...
	LoadFont("Common Normal") .. {
		InitCommand = function(self)
			...
			--(SCREEN_CENTER_X - capWideScale(125,175) original
		end,
		BeginCommand = function(self)
			self:queuecommand("Set")
		end,
	...
	UIElements.TextToolTip(1, 1, "Common Normal") .. {
		Name = "Version",
		InitCommand = function(self)
			self:xy(SCREEN_WIDTH - 3, AvatarY + 20):halign(1):zoom(0.42):diffuse(ButtonColor)
		end,
		BeginCommand = function(self)
			self:queuecommand("Set")
		end,
	...
	UIElements.TextToolTip(1, 1, "Common Normal") .. {
		Name = "refreshbutton",
		InitCommand = function(self)
			self:xy(SCREEN_WIDTH - 3, AvatarY + 30):halign(1):zoom(0.35):diffuse(ButtonColor)
		end,
		BeginCommand = function(self)
			self:queuecommand("Set")
		end,
