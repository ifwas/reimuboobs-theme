...
function AdvancedPlayerTracker()
	local t = {
        Name = "AdvancedPlayerTracker",
        LayoutType = "ShowAllInRow",
        SelectType = "SelectOne",
        OneChoiceForAllPlayers = true,
        ExportOnChange = true,
        ...
        Choices = {THEME:GetString("OptionNames", "Off"), THEME:GetString("OptionNames", "On")},
        LoadSelections = function(self, list, pn)
            local pref = themeConfig:get_data().global.AdvancedPlayerTracker
            if pref then
                list[2] = true
            else
                list[1] = true
        ...
        SaveSelections = function(self, list, pn)
            ...
            themeConfig:get_data().global.AdvancedPlayerTracker = value
            themeConfig:set_dirty()
            themeConfig:save()
        end
    }
...
function ShowOffsetScoreTab()
	local t = {
        Name = "ShowOffsetScoreTab",
        LayoutType = "ShowAllInRow",
        SelectType = "SelectOne",
        OneChoiceForAllPlayers = true,
        ExportOnChange = true,
        ...
        Choices = {THEME:GetString("OptionNames", "Off"), THEME:GetString("OptionNames", "On")},
        LoadSelections = function(self, list, pn)
            local pref = themeConfig:get_data().global.ShowOffsetScoreTab
            if pref then
                list[2] = true
            else
                list[1] = true
...
function HideFancyParticles()
	local t = {
        Name = "HideFancyParticles",
        LayoutType = "ShowAllInRow",
        SelectType = "SelectOne",
        OneChoiceForAllPlayers = true,
        ExportOnChange = true,
        ...
        Choices = {THEME:GetString("OptionNames", "Off"), THEME:GetString("OptionNames", "On")},
        LoadSelections = function(self, list, pn)
            local pref = themeConfig:get_data().global.HideFancyParticles
            if pref then
                list[2] = true
            else
                list[1] = true
        ...
        SaveSelections = function(self, list, pn)
            ...
            themeConfig:get_data().global.HideFancyParticles = value
            themeConfig:set_dirty()
            themeConfig:save()
        end
    }
